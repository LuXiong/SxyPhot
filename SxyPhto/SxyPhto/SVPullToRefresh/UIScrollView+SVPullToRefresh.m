...
- (void)layoutSubviews {
    ...
    if(hasCustomView) {
        ...
        if(subtitleSize.height > 0){
            ...
            self.titleLabel.frame = CGRectIntegral(CGRectMake(labelX, titleY, subtitleSize.width, titleSize.height));
...
- (void)flashLastUpdateTime
{
    ...
    [self setSubtitle:[NSString stringWithFormat:@"上次刷新: %@", [newDateFormatter stringFromDate:[NSDate date]]] forState:SVPullToRefreshStateAll];
}
